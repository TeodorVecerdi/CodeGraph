...
namespace Editor
{
    ...
    static internal class ExtensionMenuOptions
	{
		...
		private static UnityEngine.Vector2 s_ThickGUIElementSize = new UnityEngine.Vector2(kWidth, kThickHeight);
		private static UnityEngine.Vector2 s_ThinGUIElementSize = new UnityEngine.Vector2(kWidth, kThinHeight);
		private static UnityEngine.Vector2 s_ImageGUIElementSize = new UnityEngine.Vector2(100f, 100f);
		...
		private static void SetPositionVisibleinSceneView(RectTransform canvasRTransform, RectTransform itemTransform)
		{
			...
			UnityEngine.Vector2 localPlanePosition;
			Camera camera = sceneView.camera;
			Vector3 position = Vector3.zero;
			if (RectTransformUtility.ScreenPointToLocalPointInRectangle(canvasRTransform, new UnityEngine.Vector2(camera.pixelWidth / 2, camera.pixelHeight / 2), camera, out localPlanePosition))
			{
		...
		private static GameObject CreateUIElementRoot(string name, MenuCommand menuCommand, UnityEngine.Vector2 size)
		{
		...
		static public void AddHorizontalScrollSnap(MenuCommand menuCommand)
		{
			...
			rectTransformScrollSnapRoot.anchorMin = new UnityEngine.Vector2(0.5f, 0.5f);
			rectTransformScrollSnapRoot.anchorMax = new UnityEngine.Vector2(0.5f, 0.5f);
			rectTransformScrollSnapRoot.anchoredPosition = UnityEngine.Vector2.zero;
			rectTransformScrollSnapRoot.sizeDelta = new UnityEngine.Vector2(300f, 150f);
			...
			rectTransformContent.anchorMin = UnityEngine.Vector2.zero;
			rectTransformContent.anchorMax = new UnityEngine.Vector2(1f, 1f);
			rectTransformContent.sizeDelta = UnityEngine.Vector2.zero;
			...
			rectTransformPage01.anchorMin = new UnityEngine.Vector2(0f, 0.5f);
			rectTransformPage01.anchorMax = new UnityEngine.Vector2(0f, 0.5f);
			rectTransformPage01.pivot = new UnityEngine.Vector2(0f, 0.5f);
			...
			rectTransformPage01Text.anchorMin = new UnityEngine.Vector2(0.5f, 0.5f);
			rectTransformPage01Text.anchorMax = new UnityEngine.Vector2(0.5f, 0.5f);
			rectTransformPage01Text.pivot = new UnityEngine.Vector2(0.5f, 0.5f);
		...
		static public void AddVerticallScrollSnap(MenuCommand menuCommand)
		{
			...
			RectTransform rectTransformPage01 = childPage01.GetComponent<RectTransform>();
			rectTransformPage01.anchorMin = new UnityEngine.Vector2(0.5f, 0f);
			rectTransformPage01.anchorMax = new UnityEngine.Vector2(0.5f, 0f);
			rectTransformPage01.anchoredPosition = new UnityEngine.Vector2(-rectTransformPage01.sizeDelta.x / 2, rectTransformPage01.sizeDelta.y / 2);
			//rectTransformPage01.anchoredPosition = Vector2.zero;
			//rectTransformPage01.sizeDelta = Vector2.zero;
			rectTransformPage01.pivot = new UnityEngine.Vector2(0.5f, 0f);
		...
		static public void FixedScrollSnapBase(MenuCommand menuCommand, string name, ScrollSnap.ScrollDirection direction, int itemVisible, int itemCount, UnityEngine.Vector2 itemSize)
		{
			...
			{
				rectTransformScrollSnapRoot.sizeDelta = new UnityEngine.Vector2(itemVisible * itemSize.x, itemSize.y);
			}
			else
			{
				rectTransformScrollSnapRoot.sizeDelta = new UnityEngine.Vector2(itemSize.x, itemVisible * itemSize.y);
			}
		...
		{
			FixedScrollSnapBase(menuCommand, "Scroll Snap Horizontal Single", ScrollSnap.ScrollDirection.Horizontal, 1, 3, new UnityEngine.Vector2(100, 100));
		}
		...
		{
			FixedScrollSnapBase(menuCommand, "Scroll Snap Horizontal Multiple", ScrollSnap.ScrollDirection.Horizontal, 3, 15, new UnityEngine.Vector2(100, 100));
		}
		...
		{
			FixedScrollSnapBase(menuCommand, "Scroll Snap Vertical Multiple", ScrollSnap.ScrollDirection.Vertical, 1, 3, new UnityEngine.Vector2(100, 100));
		}
		...
		{
			FixedScrollSnapBase(menuCommand, "Scroll Snap Vertical Multiple", ScrollSnap.ScrollDirection.Vertical, 3, 15, new UnityEngine.Vector2(100, 100));
		}
		#endregion
		...
		static public void AddUIVerticallScroller(MenuCommand menuCommand)
		{
			...
			rectTransformScrollSnapRoot.anchorMax = new UnityEngine.Vector2(0.5f, 0.5f);
			rectTransformScrollSnapRoot.anchoredPosition = UnityEngine.Vector2.zero;
			rectTransformScrollSnapRoot.sizeDelta = new UnityEngine.Vector2(500f, 150f);
			...
			rectTransformCenter.anchorMin = new UnityEngine.Vector2(0f, 0.3f);
			rectTransformCenter.anchorMax = new UnityEngine.Vector2(1f, 0.6f);
			rectTransformCenter.sizeDelta = UnityEngine.Vector2.zero;
			...
			for (int i = 0; i < 10; i++)
			{
				...
				rectTransformPage.anchorMin = new UnityEngine.Vector2(0f, 0.5f);
				rectTransformPage.anchorMax = new UnityEngine.Vector2(1f, 0.5f);
				rectTransformPage.sizeDelta = new UnityEngine.Vector2(0f, 80f);
				rectTransformPage.pivot = new UnityEngine.Vector2(0.5f, 0.5f);
				...
				rectTransformPageText.anchorMin = new UnityEngine.Vector2(0.5f, 0.5f);
				rectTransformPageText.anchorMax = new UnityEngine.Vector2(0.5f, 0.5f);
				rectTransformPageText.pivot = new UnityEngine.Vector2(0.5f, 0.5f);
			}
		...
		static public void AddAutoCompleteComboBox(MenuCommand menuCommand)
		{
			...
			inputFieldRT.anchorMin = UnityEngine.Vector2.zero;
			inputFieldRT.anchorMax = UnityEngine.Vector2.one;
			inputFieldRT.sizeDelta = UnityEngine.Vector2.zero;
			...
			overlayRT.anchorMin = new UnityEngine.Vector2(0f, 1f);
			overlayRT.anchorMax = new UnityEngine.Vector2(0f, 1f);
			overlayRT.sizeDelta = new UnityEngine.Vector2(0f, 1f);
			overlayRT.pivot = new UnityEngine.Vector2(0f, 1f);
			...
			overlayScrollPanelRT.anchorMin = new UnityEngine.Vector2(0f, 1f);
			overlayScrollPanelRT.anchorMax = new UnityEngine.Vector2(0f, 1f);
			overlayScrollPanelRT.sizeDelta = new UnityEngine.Vector2(cbbRT.sizeDelta.x, cbbRT.sizeDelta.y * 3);
			overlayScrollPanelRT.pivot = new UnityEngine.Vector2(0f, 1f);
			...
			overlayScrollPanelItemsRT.anchorMin = new UnityEngine.Vector2(0f, 1f);
			overlayScrollPanelItemsRT.anchorMax = new UnityEngine.Vector2(0f, 1f);
			overlayScrollPanelItemsRT.sizeDelta = new UnityEngine.Vector2(120f, 5f);
			overlayScrollPanelItemsRT.pivot = new UnityEngine.Vector2(0f, 1f);
			...
			overlayScrollPanelScrollbarRT.anchorMin = new UnityEngine.Vector2(1f, 0f);
			overlayScrollPanelScrollbarRT.anchorMax = UnityEngine.Vector2.one;
			overlayScrollPanelScrollbarRT.sizeDelta = new UnityEngine.Vector2(cbbRT.sizeDelta.y, 0f);
			overlayScrollPanelScrollbarRT.pivot = UnityEngine.Vector2.one;
			...
			arrowButtonRT.anchorMin = UnityEngine.Vector2.one;
			arrowButtonRT.anchorMax = UnityEngine.Vector2.one;
			arrowButtonRT.sizeDelta = new UnityEngine.Vector2(cbbRT.sizeDelta.y, cbbRT.sizeDelta.y);
			arrowButtonRT.pivot = UnityEngine.Vector2.one;
		...
		static public void AddDropDownList(MenuCommand menuCommand)
		{
			...
			itemTemplateImageRT.anchorMin = UnityEngine.Vector2.zero;
			itemTemplateImageRT.anchorMax = new UnityEngine.Vector2(0f, 1f);
			itemTemplateImageRT.pivot = new UnityEngine.Vector2(0f, 1f);
			itemTemplateImageRT.sizeDelta = UnityEngine.Vector2.one;
			itemTemplateImageRT.offsetMin = new UnityEngine.Vector2(4f, 4f);
			itemTemplateImageRT.offsetMax = new UnityEngine.Vector2(22f, -4f);
			itemTemplateImage.GetComponent<Image>().color = new Color(0, 0, 0, 0);

			//Setup Main Button
			mainButton.name = "MainButton";
			var mainButtonRT = mainButton.GetComponent<RectTransform>();
			mainButtonRT.anchorMin = UnityEngine.Vector2.zero;
			mainButtonRT.anchorMax = UnityEngine.Vector2.one;
			mainButtonRT.sizeDelta = UnityEngine.Vector2.zero;
			UnityEditor.Events.UnityEventTools.AddBoolPersistentListener(mainButton.GetComponent<Button>().onClick, new UnityEngine.Events.UnityAction<bool>(dropDownList.ToggleDropdownPanel), true);
			...
			mainButtonTextRT.anchorMin = UnityEngine.Vector2.zero;
			mainButtonTextRT.anchorMin = UnityEngine.Vector2.zero;
			mainButtonTextRT.pivot = new UnityEngine.Vector2(0f, 1f);
			mainButtonTextRT.offsetMin = new UnityEngine.Vector2(10f, 0f);
			mainButtonTextRT.offsetMax = new UnityEngine.Vector2(-4f, 0f);
			//Main Button Image
			var mainButtonImageRT = mainButtonImage.GetComponent<RectTransform>();
			mainButtonImageRT.anchorMin = UnityEngine.Vector2.zero;
			mainButtonImageRT.anchorMax = new UnityEngine.Vector2(0f, 1f);
			mainButtonImageRT.pivot = new UnityEngine.Vector2(0f, 1f);
			mainButtonImageRT.sizeDelta = UnityEngine.Vector2.one;
			mainButtonImageRT.offsetMin = new UnityEngine.Vector2(4f, 4f);
			mainButtonImageRT.offsetMax = new UnityEngine.Vector2(22f, -4f);
			...
			overlayRT.pivot = new UnityEngine.Vector2(0f, 1f);
			overlay.AddComponent<Image>().color = new Color(0.243f, 0.871f, 0f, 0f);
			UnityEditor.Events.UnityEventTools.AddBoolPersistentListener(overlay.AddComponent<Button>().onClick, new UnityEngine.Events.UnityAction<bool>(dropDownList.ToggleDropdownPanel), true);
			//Overlay Scroll Panel
			var overlayScrollPanelRT = overlayScrollPanel.GetComponent<RectTransform>();
			overlayScrollPanelRT.position += new Vector3(0, -cbbRT.sizeDelta.y, 0);
			overlayScrollPanelRT.anchorMin = new UnityEngine.Vector2(0f, 1f);
			...
			arrowTextRT.anchorMin = new UnityEngine.Vector2(1f, 0f);
			arrowTextRT.anchorMax = UnityEngine.Vector2.one;
			arrowTextRT.sizeDelta = new UnityEngine.Vector2(cbbRT.sizeDelta.y, cbbRT.sizeDelta.y);
			arrowTextRT.pivot = new UnityEngine.Vector2(1f, 0.5f);
		...
		private static void CreateToolTipItem(bool select, GameObject parent)
		{
			...
			if (btti == null)
			{
				...
				boundTooltipItemTextRT.anchorMin = UnityEngine.Vector2.zero;
				boundTooltipItemTextRT.anchorMax = UnityEngine.Vector2.one;
				boundTooltipItemTextRT.sizeDelta = UnityEngine.Vector2.one;
		...
		static public void AddSlider(MenuCommand menuCommand)
		{
			...
			backgroundRect.anchorMin = new UnityEngine.Vector2(0, 0.25f);
			backgroundRect.anchorMax = new UnityEngine.Vector2(1, 0.75f);
			backgroundRect.sizeDelta = new UnityEngine.Vector2(0, 0);

			// Fill Area
			RectTransform fillAreaRect = fillArea.GetComponent<RectTransform>();
			fillAreaRect.anchorMin = new UnityEngine.Vector2(0, 0.25f);
			fillAreaRect.anchorMax = new UnityEngine.Vector2(1, 0.75f);
			fillAreaRect.anchoredPosition = UnityEngine.Vector2.zero;
			fillAreaRect.sizeDelta = UnityEngine.Vector2.zero;
			...
			fillRect.sizeDelta = UnityEngine.Vector2.zero;
		...
		static public void AddReorderableScrollRectVertical(MenuCommand menuCommand)
		{
			...
			rectTransformScrollSnapRoot.anchorMax = new UnityEngine.Vector2(0.5f, 0.5f);
			rectTransformScrollSnapRoot.anchoredPosition = UnityEngine.Vector2.zero;
			rectTransformScrollSnapRoot.sizeDelta = new UnityEngine.Vector2(150f, 150f);
			...
			rectTransformElement01.anchorMin = new UnityEngine.Vector2(0f, 0.5f);
			rectTransformElement01.anchorMax = new UnityEngine.Vector2(0f, 0.5f);
			rectTransformElement01.pivot = new UnityEngine.Vector2(0.5f, 0.5f);
			...
			rectTransformElement02.anchorMin = new UnityEngine.Vector2(0f, 0.5f);
			rectTransformElement02.anchorMax = new UnityEngine.Vector2(0f, 0.5f);
			rectTransformElement02.pivot = new UnityEngine.Vector2(0.5f, 0.5f);
			...
			rectTransformElement03.anchorMin = new UnityEngine.Vector2(0f, 0.5f);
			rectTransformElement03.anchorMax = new UnityEngine.Vector2(0f, 0.5f);
			rectTransformElement03.pivot = new UnityEngine.Vector2(0.5f, 0.5f);
		...
		static public void AddReorderableScrollRectGrid(MenuCommand menuCommand)
		{
			...
			childContentGLG.cellSize = new UnityEngine.Vector2(30, 30);
			childContentGLG.spacing = new UnityEngine.Vector2(10, 10);
			ContentSizeFitter childContentCSF = childContent.AddComponent<ContentSizeFitter>();
			childContentCSF.verticalFit = ContentSizeFitter.FitMode.PreferredSize;
        ...
        {
            GameObject go = CreateUIElementRoot("Stepper", menuCommand, new UnityEngine.Vector2(42, kThinHeight));
        ...
        static public void AddBoxSlider(MenuCommand menuCommand)
        {
            ...
            handleRect.sizeDelta = new UnityEngine.Vector2(25, 25);
        ...
        static public void AddRadialSlider(MenuCommand menuCommand)
        {
            ...
            sliderRootRectTransform.anchorMin = new UnityEngine.Vector2(0.5f, 0.5f);
            sliderRootRectTransform.anchorMax = new UnityEngine.Vector2(0.5f, 0.5f);
            sliderRootRectTransform.anchoredPosition = UnityEngine.Vector2.zero;
            sliderRootRectTransform.sizeDelta = new UnityEngine.Vector2(250f, 250f);
            ...
            sliderRectTransform.anchorMin = UnityEngine.Vector2.zero;
            sliderRectTransform.anchorMax = UnityEngine.Vector2.one;
            sliderRectTransform.sizeDelta = UnityEngine.Vector2.zero;
        ...
        private static GameObject AddInputFieldAsChild(GameObject parent)
		{
			...
			textRectTransform.anchorMax = UnityEngine.Vector2.one;
			textRectTransform.sizeDelta = UnityEngine.Vector2.zero;
			textRectTransform.offsetMin = new UnityEngine.Vector2(10, 6);
			textRectTransform.offsetMax = new UnityEngine.Vector2(-10, -7);

			RectTransform placeholderRectTransform = childPlaceholder.GetComponent<RectTransform>();
			placeholderRectTransform.anchorMin = UnityEngine.Vector2.zero;
			placeholderRectTransform.anchorMax = UnityEngine.Vector2.one;
			placeholderRectTransform.sizeDelta = UnityEngine.Vector2.zero;
			placeholderRectTransform.offsetMin = new UnityEngine.Vector2(10, 6);
			placeholderRectTransform.offsetMax = new UnityEngine.Vector2(-10, -7);
		...
		private static GameObject AddScrollbarAsChild(GameObject parent)
		{
			...
			sliderAreaRect.sizeDelta = new UnityEngine.Vector2(-20, -20);
			sliderAreaRect.anchorMin = UnityEngine.Vector2.zero;
			sliderAreaRect.anchorMax = UnityEngine.Vector2.one;

			RectTransform handleRect = handle.GetComponent<RectTransform>();
			handleRect.sizeDelta = new UnityEngine.Vector2(20, 20);
        ...
        private static RectTransform SetAnchorsAndStretch(GameObject root)
        {
            ...
            rectTransformRoot.anchorMin = new UnityEngine.Vector2(0.5f, 0.5f);
            rectTransformRoot.anchorMax = new UnityEngine.Vector2(0.5f, 0.5f);
            rectTransformRoot.anchoredPosition = UnityEngine.Vector2.zero;
