...
namespace CodeGraph.Editor {
    public class CreateCodeGraphMonoBehaviour : EndNameEditAction {
        [MenuItem("Assets/Create/Empty Code Graph MonoBehaviour", false, 0)]
        public static void CreateEmptyCodeGraph() {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateCodeGraphMonoBehaviour>(),
                "New Code Graph MonoBehaviour.codegraph", Resources.Load<Texture2D>("codegraph_256"), null);
        }
        ...
        public override void Action(int instanceId, string pathName, string resourceFile) {
            ...
            var graph = new CodeGraphData {AssetPath = pathName, GraphName = graphName, IsMonoBehaviour = true};
